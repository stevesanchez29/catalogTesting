...
# Menu for Marky Mark Burgers
restaurant1 = Restaurant(user_id=1, name="Marky Mark Burgers")
...
# Menu for Lucy Lui's Delights
restaurant2 = Restaurant(user_id=1, name="Lucy Lui\'s Delights")
...
# Menu for Buddy The Furry Playful Panda
restaurant1 = Restaurant(user_id=1, name="Buddy The Furry Playful Panda")
...
# Menu for Animal Lovers Veggie Diner
restaurant1 = Restaurant(user_id=1, name=" Animal Lovers Veggie Diner ")
...
# Menu for Jay Z's East Coast Grub
restaurant1 = Restaurant(user_id=1, name="Jay Z\'s East Coast Grub ")
...
# Menu for Obama's Amazing World
restaurant1 = Restaurant(user_id=1, name="Obama\'s Amazing World")
...
# Menu for Gramma's Home Cookin
restaurant1 = Restaurant(user_id=1, name="Yo Gramma\'s Home Cookin' ")
...
# Menu for Ariana's Grande TexMexx
restaurant1 = Restaurant(user_id=1, name="Ariana\'s Grande TexMexx ")
